...
struct VulkanGraphicsPlugin : public IGraphicsPlugin {
    VulkanGraphicsPlugin(const Options* options, IPlatformPlugin* /*unused*/)
        : m_clearColor(GetBackgroundClearColor(options)) {
...
#include "frag.spv"
    ...
    void UpdateOptions(const Options* options) override { m_clearColor = GetBackgroundClearColor(options); }
...
struct VulkanGraphicsPluginLegacy : public VulkanGraphicsPlugin {
    VulkanGraphicsPluginLegacy(const Options* options, IPlatformPlugin* platformPlugin)
...
IGraphicsPlugin* CreateGraphicsPlugin_Vulkan(const Options* options,
                                                             IPlatformPlugin* platformPlugin) {
    return std::make_shared<VulkanGraphicsPlugin>(options, std::move(platformPlugin));
}

IGraphicsPlugin* CreateGraphicsPlugin_VulkanLegacy(const Options* options,
                                                                   IPlatformPlugin* platformPlugin) {
