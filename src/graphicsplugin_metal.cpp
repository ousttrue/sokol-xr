...
struct MetalGraphicsPlugin : public IGraphicsPlugin {
    MetalGraphicsPlugin(const Options* /*options*/, IPlatformPlugin*) {}
...
IGraphicsPlugin* CreateGraphicsPlugin_Metal(const Options* options,
                                                            IPlatformPlugin* platformPlugin) {
    return new MetalGraphicsPlugin(options, platformPlugin);
}
