...
struct D3D12GraphicsPlugin : public IGraphicsPlugin {
    D3D12GraphicsPlugin(const Options* options, IPlatformPlugin*)
...
IGraphicsPlugin* CreateGraphicsPlugin_D3D12(const Options* options,
                                                            IPlatformPlugin* platformPlugin) {
    return new D3D12GraphicsPlugin(options, platformPlugin);
}
