...
struct OpenGLGraphicsPlugin : public IGraphicsPlugin {
    OpenGLGraphicsPlugin(const Options* options, IPlatformPlugin* /*unused*/&)
...
IGraphicsPlugin* CreateGraphicsPlugin_OpenGL(const Options* options,
                                                             IPlatformPlugin* platformPlugin) {
    return new OpenGLGraphicsPlugin(options, platformPlugin);
}
